...
| <a href="https://petit-marche-4lso.vercel.app/" target="_blank">Petit-Marche（現在フロント部分のみ）</a> | <a href="https://github.com/tatsuya1981/Petit-Marche" target="_blank" >リポジトリ</a> |
| :-- | :-- |
...
| ブログ投稿型のシンプルなAPIです。<br/>バックエンドの学習課題として作成しました。<br/> | 自身のリポジトリのissueに対して<br/>CRUDを実行するアプリです。<br />Reactを使ったAPI通信の学習課題として作成しました。<br/>|
...
| 誰もが１度は遊んだことがあるかも・・・？<br/>Reactの学習課題として作成しました。<br/> | codepenサイトを想定した模写トレーニングです。<br/>webサイト作成の練習課題として作成しました。<br/>|
